...
export class UserController {
  ...
  public static async signup(req: Request, res: Response) {
    try {
      ...
      const isEmailExits = await this.isUserEmailTaken(email);
      const isUsernameExits = await this.isUsernameTaken(username);
      ...
      const newUser = await this.createUser({ email, password, username });

      generateToken(JSON.stringify(newUser.id), res);
  ...
  public static async signin(req: Request, res: Response) {
    try {
      ...
      generateToken(JSON.stringify(user.id), res);
